...
| [`set_metaliquidity_whitelist`](#set_metaliquidity_whitelist) | Voto de lista blanca MLP | clave de validador |
| [`register_metaliquidity_operator`](#register_metaliquidity_operator) | Registrar / revocar un operador de estrategia | líder de vault |
...
| `AppHashVote` | — | Acción de validador/sistema; va por la ruta de consenso, nunca por `/exchange` |
...
| `AppHashVote` | — | Acción de validador/sistema; solo por ruta de consenso | — |
