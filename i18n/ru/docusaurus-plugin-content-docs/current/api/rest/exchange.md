...
| [`REDACTED`](#REDACTED) | Голосование за белый список MLP | ключ валидатора |
| [`REDACTED`](#REDACTED) | Зарегистрировать / отозвать оператора стратегии | лидер хранилища |
...
| `REDACTED` | — | Действие валидатора/системы; проходит через путь консенсуса, никогда через `/exchange` |
...
| `REDACTED` | — | Действие валидатора/системы; только путь консенсуса | — |
