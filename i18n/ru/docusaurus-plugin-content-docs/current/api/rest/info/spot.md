...
## Типы запросов: спот, маржа и Earn {#spot-spot-margin--earn-query-types}

### Список спотовых пар и реестр токенов {#spot_meta}
...
### Балансы спотовых токенов по аккаунту {#spot_clearinghouse_state}
...
### Все маржинальные позиции аккаунта {#spot_margin_state}
...
### Пулы кредитования Earn и доля аккаунта {#earn_state}
...
### Состояние газового аукциона на деплой спотовых пар {#spot_deploy_state}
