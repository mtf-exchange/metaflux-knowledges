...
:::info
**仅无杠杆现货符合伊斯兰教义。** 只有**无杠杆**现货交易 — 即按全额价值直接买入和卖出，无杠杆、无保证金、无借贷、无资金费用 — 是 MetaFlux 通常被认为符合伊斯兰（Sharia）金融原则的产品。不合规的产品明确包括**现货保证金（杠杆现货交易）**，以及永续合约和其他所有杠杆或衍生品类产品 — 杠杆和借贷引入利息（riba）、投机和不确定性（maysir、gharar）。详见 [现货交易](./spot-trading.md)。本说明仅供参考，不构成宗教或财务建议。
:::
