...
| [`set_metaliquidity_whitelist`](#set_metaliquidity_whitelist) | MLP 白名单投票 | 验证器密钥 |
| [`register_metaliquidity_operator`](#register_metaliquidity_operator) | 注册/撤销策略运营商 | 金库领导者 |
...
| `BorrowLend` | — | 不桥接 |
| `AppHashVote` | — | 验证器/系统操作；通过共识路径，永不 `/exchange` |
