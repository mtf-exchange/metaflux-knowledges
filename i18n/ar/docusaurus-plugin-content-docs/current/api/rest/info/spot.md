...
## أنواع استعلامات السوق الفوري والهامش وEarn {#spot-spot-margin--earn-query-types}

### مجموعة أزواج العملات الفورية وسجل الرموز {#spot_meta}
...
### أرصدة الرموز الفورية لكل حساب {#spot_clearinghouse_state}
...
### كل مركز هامش عملات فورية لحساب واحد {#spot_margin_state}
...
### تجمعات إقراض Earn وحصة الحساب فيها {#earn_state}
...
### حالة مزاد الغاز لنشر أزواج العملات الفورية {#spot_deploy_state}
