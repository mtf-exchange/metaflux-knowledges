...
| Chaîne | Statut |
|--------|--------|
| Base | **actif sur Base Sepolia** (`MetaBridgeUSDC` v3 [`0xaCF3d88013b6Bd5022cF8e8259Bd1326Ee8B73Af`](https://sepolia.basescan.org/address/0xaCF3d88013b6Bd5022cF8e8259Bd1326Ee8B73Af)) ; mainnet en pré-audit |
| Solana | **actif sur devnet** (programme `metabridge-solana` [`Db5KYqPTFv3naxWTx83EzXQaZPMmbbAbaWHbZxK71sLB`](https://solscan.io/account/Db5KYqPTFv3naxWTx83EzXQaZPMmbbAbaWHbZxK71sLB?cluster=devnet)) ; mainnet en pré-audit |
| Arbitrum | prévu |
