...
| [MIP-3](./mip-3.md) | Permissionless perp market deploy | Implemented — the [nine deploy actions](./mip-3.md) are **built, not yet released** |
...
V1 covers MIP-1, MIP-2, and MIP-3. MIP-4 (aggregator) is targeted for V2; MIP-6 (Outcomes) is deferred to V3. MIP-5 (Earn) is live: deposit and redeem work, and it pays zero until two governance votes land — see [Earn](../concepts/earn.md).
