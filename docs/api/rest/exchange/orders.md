...
**An unfunded rung fails alone.** Each rung posts in ladder order and locks its
own escrow. A rung the spot wallet cannot fund is refused in that rung's own
status (`insufficient spot balance`), and the earlier rungs stay.
