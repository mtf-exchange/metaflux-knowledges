...
**Part of the split rules below is already superseded.** Read
[the standard-mode split](../concepts/usdc.md#standard-split) and
[the rules node 0.9.10 changed](./block-11550001.md#no-height-pin) before you code to them.
:::
